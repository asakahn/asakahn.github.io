...
const navbarExpand = () => {
    let navContainer = document.getElementById("NavbarExtendedContainer")
    navbarExpanded = !navbarExpanded
    if(navbarExpanded){
        navContainer.style.maxHeight = "600px"
        navContainer.style.opacity = "1"
        navContainer.style.padding = "16px"
    } else {
...
window.addEventListener("resize", (e) => {
    let screenW = e.currentTarget.innerWidth
    if(navbarExpanded == true && screenW >= 666){
        navbarExpand()
    }
})
